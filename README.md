...
- SBOMs generated by "app" include only those modules that the target application
...
- SBOMs generated by "mod" include the aggregate of modules required by all 
...
Vendors or organizations may choose to use "mod" for internal use, where it's too
